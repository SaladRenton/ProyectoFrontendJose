...
import { revertirLotePaquete } from '../../../core/_requests';


interface RevertirLotePaqueteModalProps {
  open: boolean;
  onClose: () => void;
...
const RevertirLotePaqueteModal: React.FC<RevertirLotePaqueteModalProps> = ({ open, onClose, onSuccess }) => {
...
export default RevertirLotePaqueteModal;
